...
- **角色创建** — 自定义姓名 + 选择打法风格（灵巧战术型 / 底线力量型 / 跑动防守型），打法决定力量/技术/敏捷专项训练的成长加成。
- **月度计划** — 每月四周，拖拽分配训练、休息、参赛，体力实时校验
- **四大赛事体系** — CTJ 青少年 → ITF Junior → ITF 职业 → WTA 职业，按年龄与积分逐步解锁
  - CTJ 12–14 岁（15 岁起截断）、ITF Junior 13–18 岁（19 岁起截断）、ITF / WTA 14 岁起开放
- **赛季日历** — 全年赛事总览，点击任意一站弹出底部抽屉，查看每轮可得的排名积分和奖金
- **打法克制系统** — 对手随机为力量型/技术型/敏捷型，存在三角克制关系影响胜率（自开局即启用）
...
3. 12 岁起即可进行力量 / 技术 / 敏捷 / 录像复盘四项专项训练，按打法风格享受成长加成
4. 12–14 岁可打 CTJ 青少年赛事，13–18 岁参加 ITF Junior 国际青少年赛事
5. 通过积分达标后报名 ITF 职业赛，再冲击 WTA
